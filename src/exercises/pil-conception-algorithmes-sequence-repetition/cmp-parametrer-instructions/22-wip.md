...
- Représentation(s) autorisée(s) pour cette série : consigne en langage naturel et instructions Blockly textuelles déjà prises en charge par le build (`move:`), fournies à l'élève comme éléments déjà écrits.
...
- Consigne attendue : sélectionner toutes les instructions dont le nombre entre parenthèses correspond à l'affiche.
...
- Nouveau pilote 22 : à reviewer après cette réécriture
