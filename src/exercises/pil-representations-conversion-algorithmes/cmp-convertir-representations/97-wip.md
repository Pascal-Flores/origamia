...
- Décision : déclinaison et review de 209–210 autorisées à la demande explicite de l'utilisateur, à partir des variantes 97–99 déjà en `testing`.
...
- 209 abandonne `rit-preparer-coucher`, déjà utilisé par l'exercice 183, et utilise `rit-melanger-cartes-distribuer`, non utilisé ailleurs dans le corpus vérifié. La conversion proposée garde les actions mais utilise une mauvaise répétition ; le texte corrigé vérifie nombre, action répétée et action finale.
- 210 abandonne `rit-ranger-chambre-10-min`, déjà utilisé par l'exercice 174, et utilise `rit-preparer-exposition-maison`, non utilisé ailleurs dans le corpus vérifié. La conversion proposée modifie le nombre de répétitions et place l'ouverture de l'exposition dans la répétition ; le texte de correction rétablit nombre, deux actions répétées et action hors boucle.

## Review

Verdict : **OK**.

- 209 utilise 3 trous et 6 étiquettes, dans la forme de 97 et 99.
- 210 utilise 4 trous et 7 étiquettes, dans la forme plus développée de 98.
...
- Déclinaison : autorisée pour 209–210
